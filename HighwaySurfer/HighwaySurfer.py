...
while begin == True:
    ...
    #Sets the key repeat delay in miliseconds.
    ...
    while not done:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                #LEFT
                if event.key == pygame.K_1 and currentx > lane1x:
                    currentx -= 20
                elif event.key == pygame.K_2 and currentx > lane1x:
                    currentx -= 15
                elif event.key == pygame.K_3 and currentx > lane1x:
                    currentx -= 10
                elif event.key == pygame.K_4 and currentx > lane1x:
                    currentx -= 5
                #RIGHT
                elif event.key == pygame.K_5 and currentx < lane3x:
                    currentx += 5
                elif event.key == pygame.K_6 and currentx < lane3x:
                    currentx += 10
                elif event.key == pygame.K_7 and currentx < lane3x:
                    currentx += 15
                elif event.key == pygame.K_8 and currentx < lane3x:
                    currentx += 20
        ...
        #if trafficLane == 1:
        if (currentx <= lane1x + 75) and trafficLane == 1 and trafficY >= (screenHeight-180-170) and trafficY < screenHeight:
            screen.fill(BLACK)
            crash()
            time.sleep(1)
            break
        ...
        #elif trafficLane == 2:
        if (currentx >= lane2x-75 and currentx <= lane2x+75) and trafficLane == 2 and  trafficY >= (screenHeight-180-170) and trafficY < screenHeight:
            screen.fill(BLACK)
            crash()
            time.sleep(1)
            break
        #else:
        if (currentx >= lane3x-75) and trafficLane == 3 and  trafficY >= (screenHeight-180-170) and trafficY < screenHeight:
            screen.fill(BLACK)
            crash()
            time.sleep(1)
            break
